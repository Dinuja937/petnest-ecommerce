            ...
            <ul className="space-y-4">
              {contactInfo.map((item) => (
                <li key={item.text} className="flex items-start gap-3">
                  ...
                  {item.href ? (
                    <a href={item.href} className="text-blue-200 hover:text-white text-sm transition-colors duration-250">
                      {item.text}
                    </a>
                  ) : (
